...
export const pageFeatures: BoxesListItem[] = [
  ...
  {
    icon: (
      <FontAwesomeIcon icon={faSpellCheck} className="font-bold text-white text-2xl icon-in-box" />
    ),
  ...
  {
    icon: <FontAwesomeIcon icon={faBoxes} className="font-bold text-white text-2xl icon-in-box" />,
    title: "Możliwość rozbudowy",
    description: (
      <p>
        Modułowa budowa wykonywanych projektów pozwala na rozbudowywanie witryny w przyszłości,
        jeśli zaszłaby potrzeba dodania dodatkowych funkcjonalności czy elementów.
      </p>
    ),
  },
  {
    icon: (
      <FontAwesomeIcon icon={faCheckDouble} className="font-bold text-white text-2xl icon-in-box" />
    ),
    title: "Prostota zarządzania treścią",
    description: (
      <p>
        Indywidualne podejście do wykonywanych witryn pozwala doskonale dopasować panel zarządzania
        treścią strony, aby praktycznie każdy bez znajomości programowania mógł z przyjemnością nią
        zarządzać.
      </p>
    ),
  },
  ...
  {
    icon: (
      <FontAwesomeIcon icon={faPalette} className="font-bold text-white text-2xl icon-in-box" />
    ),
    title: "Nowoczesny design",
    description: (
      <p>
        Wykonuję strony internetowe, które cieszą oko swoim wyglądem oraz działaniem. Śledzę
        aktualne oraz dopiero pojawiające się światowe trendy w zakresie projektowania stron i
        staram się przekładać zdobywaną wiedzę na swoje prace.
      </p>
    ),
  },
];
