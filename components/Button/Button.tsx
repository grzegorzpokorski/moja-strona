  ...
  return (
    <Link
      ...
      className={`inline-flex transition-colors border-2 rounded ${
        ...
        style === "default"
          ? "bg-green hover:bg-greenHover text-white dark:text-zinc-800 border-green"
          : style === "transparentGreen"
          ? "bg-transparent hover:bg-greenHover text-green hover:text-white dark:hover:text-zinc-900 border-green"
          : style === "white"
          ...
          : style === "tag"
          ? "bg-zinc-200 dark:bg-zinc-700 hover:bg-green dark:hover:bg-green text-zinc-500 dark:text-zinc-300 hover:text-white border-0"
          : style === "whiteZinc"
